            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  <!-- configuring my route to the dashboard, and survey being defined in the navigation section-->
                  <router-link
                    v-for="item in navigation" 
                    :key="item.name" 
                    :to="item.to" 
                    active-class="bg-gray-900 text-white" 
                    :class="[$route.name === item.to ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'block rounded-md px-3 py-2 text-base font-medium']">
                    {{ item.name }}
                  </router-link>
                </div>
              </div>
        ...
        <DisclosurePanel class="md:hidden">
          ...
          <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              ...
              <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">tesing</div>
                <div class="text-sm font-medium leading-none text-gray-400">testing@gmail.com</div>
              </div>
            </div>
