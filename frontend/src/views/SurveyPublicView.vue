<template>
    <div class="py-5 py-8">
        ...
        <form @submit.prevent="submitSurvey" v-else class="container mx-auto">
            ...
            <div v-if="surveyFinished" class="py-8
             px-6 
             bg-emerald-400 
             text-white 
             w-[600px] 
             mx-auto">
                ...
                focus:ring-2
                focus:ring-offset-2
                focus:ring-indigo-500"> Submit Another Response</button>
            </div>
...
const survey =  computed(() =>store.state.currentSurvey.data)// display data of currentSurvey 

const surveyFinished = ref(false)

const answers = ref({})

store.dispatch("getSurveyBySlug", route.params.slug) //passing of parameters of slug to the getSurveySlug fucnction
